...
inshore<-read.csv("E:\\Capelin\\commercial\\inshore-commercial.csv",head=TRUE,stringsAsFactors = FALSE)
# more recent catches
recent.years<-read.csv(file="E:\\Capelin\\commercial\\corrected length and weigh freqs by year nafo and age - no month lw.txt",header=TRUE,stringsAsFactors = FALSE,skip=1)
