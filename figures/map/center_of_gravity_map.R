...
postscript("figures/center_of_gravity_map_v3.eps", height = 7, width = 7)
cgi_map()
dev.off()
...
png("figures/center_of_gravity_map_v3_alternative.png", units = "in", res = 600, height = 7, width = 7)
cgi_map()
dev.off()

postscript("figures/center_of_gravity_map_v3_alternative.eps", height = 7, width = 7)
cgi_map()
dev.off()
